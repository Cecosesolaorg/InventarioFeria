...
document.addEventListener('DOMContentLoaded', () => {
    ...
    function ejecutarEntrada() {
        ...
        const targetUrl = aisleMap[assignedAisle] || 'index.html'; // Evitamos mapa.html, si no hay ruta vuelve al login

        setTimeout(() => {
            if (targetUrl !== 'mapa.html' && targetUrl !== 'contenedor/coordinacion/coordinacion.html') {
